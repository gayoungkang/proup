...
<%
	...
	int mastersIdx = (Integer) request.getAttribute("mastersIdx");
...
<meta property="og:url" content="http://proschool.co.kr/references?view=references&menu=references_masters&masters_idx=<%=mastersIdx%>">
    ...
    <section class="data-detail-pg detail-pg">
        <div class="inner">
            ...
            <div class="btn-wrap clearfix">
                <div class="detail-select-box">
                    ...
                    <ul class="select-list">
                        <li onclick="javascript: location.href='references?view=references&menu=references_masters&masters_idx=<%=mastersIdx%>';">
                            <div class="wrap">
                                <span>정렬기준</span>
                                <img src="./images/arrow.png" alt="이미지">
                            </div>
                        </li>
                        <li><a href="javascript: referenceSearchForMasters('master_name', <%=mastersIdx%>);">마스터</a></li>
                        <li><a href="javascript: referenceSearchForMasters('date', <%=mastersIdx%>);">일시</a></li>
                        <li><a href="javascript: referenceSearchForMasters('company', <%=mastersIdx%>);">기업명</a></li>
                        <li><a href="javascript: referenceSearchForMasters('score', <%=mastersIdx%>);">평가결과</a></li>
                        <li><a href="javascript: referenceSearchForMasters('category', <%=mastersIdx%>);">카테고리</a></li>
                    </ul>
                </div>
                <a href="references?menu=references_masters_excel&masters_idx=<%=mastersIdx %>" class="excel-btn">
                    <div class="wrap">
                        <span>엑셀다운받기</span>
                        <img src="./images/arrow.png" alt="이미지">
                    </div>
            ...
            <%if("ASC".equals(orderBy)){ %>
            	<div class="updown-btn up-btn" onclick="javascript: referenceSearchOrderForMasters(<%=mastersIdx%>);">
	                <div class="wrap clearfix">
	                    <span>오름차순</span><img src="./images/table-arrow.png" alt="오름차순 버튼">
	                </div>
	            </div>
            <%}else{ %>
            	<div class="updown-btn down-btn" style="display: block;" onclick="javascript: referenceSearchOrderForMasters(<%=mastersIdx%>);">
	                <div class="wrap clearfix">
