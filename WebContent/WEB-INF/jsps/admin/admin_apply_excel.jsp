...
<%
	...
	response.setHeader("Content-Disposition", "attachment;filename=apply_"+dateStr+".xls");
	...
	objWorkBook.setSheetName(0, "마스터 지원");
	...
	objSheet.setColumnWidth(6, 5000);		//등록일
