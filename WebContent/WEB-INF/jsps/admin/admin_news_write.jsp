...
$(function(){
	...
	$("#view_date").datepicker('setDate', '<%=date %>');
...
<div class="content-wrap">
	<span class="content-title" style="margin-top: 20px;">뉴스 등록</span>
	<div class="content-div">
		
		<form action="admin" method="post" onsubmit="javascript:return addNewsSubmit();">
			<input type="hidden" name="mode" value="insert_news" />
			<table class="content-table" style="width: 1000px;">
				...
				<tr>
					...
					<td>
						<textarea id="keywords" name="keywords" class="input-default" style="height: 50px;"></textarea>
					</td>
				</tr>
